...
<div class="content">
    <div class="container-fluid">
        <div class="row">         
            <div class="col-md-8">
                <div class="card">
                    <div class="panel-title">Edit coupon</div>
                    <div class="content">
                        {!! Form::Model($coupon,array('route'=> array('coupons.update',$coupon->id),'method'=>'PATCH','class'=>'form-horizontal','autocomplete'=>'off','enctype'=>'multipart/form-data','id'=>'planner-form')) !!}
...
<div class="form-group single_code" style="display:none;">
	...
	@if(!isset($coupon->id))
	<div class="col-sm-1"><button class="btn" type="button" onclick="createCouponcode()">Create</button></div>
	@endif
</div>
