...
<div class="content">
    <div class="container-fluid">
        <div class="row">         
            <div class="col-md-10">
                <div class="card">
                <div class="col-md-12 panel-title">Edit Cms</div>
                    <div class="content">
                        {!! Form::Model($cms,array('route'=> array('cms.update',$cms->id),'method'=>'PATCH','class'=>'form-horizontal','autocomplete'=>'off','enctype'=>'multipart/form-data','id'=>'planner-form')) !!}
